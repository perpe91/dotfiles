...
let s:c.base1 = { 'gui': '#11151c', 'cterm': 232 }
...
let s:c.base9 = { 'gui': '#d3ebe9', 'cterm': 255 }

let s:c.base1 = { 'gui': '#11151c', 'cterm': 232 }
let s:c.base4 = { 'gui': '#245361', 'cterm': 29  }
let s:c.base8 = { 'gui': '#245361', 'cterm': 252  }
let s:c.base11 = { 'gui': '#245361', 'cterm': 220  }
let s:c.base12 = { 'gui': '#245361', 'cterm': 234  }
let s:c.base13 = { 'gui': '#245361', 'cterm': 236  }

" Other colors.
let s:c.red     = { 'gui': '#c23127', 'cterm': 124 }
let s:c.orange  = { 'gui': '#d26937', 'cterm': 166 }
let s:c.yellow  = { 'gui': '#edb443', 'cterm': 214 }
let s:c.magenta = { 'gui': '#888ca6', 'cterm': 214  }
let s:c.violet  = { 'gui': '#4e5166', 'cterm': 60  }
let s:c.blue    = { 'gui': '#195466', 'cterm': 27  }
let s:c.cyan    = { 'gui': '#33859E', 'cterm': 44  }
let s:c.green   = { 'gui': '#2aa889', 'cterm': 76  }
...
" Colors.
let s:N1 = s:Array('base0', 'base11')
let s:N2 = s:Array('base2', 'base11')
let s:N3 = s:Array('base9', 'base12')
...
let g:airline#themes#gotham256#palette.normal_modified = {
      \ 'airline_c': s:Array('magenta', 'base0', '')
      \ }
...
" Colors.
let s:I1 = s:Array('base0', 'yellow' )
let s:I2 = s:Array('base6', 'base3')
let s:I3 = s:Array('base8', 'base1')
...
let s:IA1 = s:Array('base0', 'base13')
let s:IA2 = s:Array('base13', 'base13')
let s:IA3 = s:Array('base8', 'base13')
...
let s:CP1 = s:Array('base9', 'base0', '')
let s:CP2 = s:Array('base9', 'base0', '')
let s:CP3 = s:Array('base0', 'base11', '')
